    ...
    public class CoreCommunicator
    {
        ...
        public CoreCommunicator()
        {
            if (!Configuration.Configuration.IsInitialized)
                throw new CommunicatorException("The communicator configuration has not been initialized.");

            LocalConfiguration = Configuration.Configuration.Instance;
            ...
            Logger.Log("communicator initialized");
        }
